...
class IpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ip" do
    assert_difference('Ip.count') do
      post ips_url, params: { ip: { device_id: @ip.device_id, hostname: @ip.hostname, ip_address: @ip.ip_address, plug: @ip.plug, room_id: @ip.room_id } }
    end
  ...
  test "should update ip" do
    patch ip_url(@ip), params: { ip: { device_id: @ip.device_id, hostname: @ip.hostname, ip_address: @ip.ip_address, plug: @ip.plug, room_id: @ip.room_id } }
